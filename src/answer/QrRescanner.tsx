...
export function QrRescanner({ onFound }: { onFound: (url: string) => void }) {
  ...
  // แผงกล้องต่อท้ายเฉลย+คำอธิบาย → บนมือถือมันตกใต้จอ (วัดจริงบน 390x844: ล้นใต้ขอบ 197px
  // เห็นแค่ 13px) = "กล้องพร้อม" ที่ผู้เล่นไม่เห็น เลยไม่รู้ว่าสแกนต่อได้เลย
  // → พอกล้องติดจริงค่อยเลื่อนเข้ามาให้เอง หน่วงไว้ก่อนเพื่อให้อ่านผลเฉลยทัน
  useEffect(() => {
