...
- **📱 โหมด QR ตอบบนมือถือ (privacy):** `settings.qrAnswerMode` (Teacher Mode) — ช่อง**ฟ้า/สาระ** พอจั่วใบเสร็จ tablet โชว์ **QR แทน UI ควิซ** (คำถามไม่โผล่บนจอกลาง = ผู้เล่นอื่นไม่เห็น) ผู้เล่นสแกนด้วยมือถือตัวเอง → เปิด `answer.html` (แยก entry โหลดเบา ~48KB ไม่ลาก MindAR) ตอบเห็นผลทันที
  ...
  - **📷 สแกนใบต่อไปบนมือถือ (`src/answer/QrRescanner.tsx`):** ตอบเสร็จ → เปิดกล้อง (jsqr) ค้างรอเล็ง QR ใบถัดไปบนจอกลางได้เลย ไม่ต้องออกไปเปิดแอปกล้องใหม่ทุกตา · เจอแล้ว `goToChallenge` พาไปการ์ดใหม่
    ...
    - แผงกล้องต่อท้ายเฉลย → **ตกใต้จอมือถือ** (วัดจริง 390×844: ล้น 197px เห็นแค่ 13px) → `scrollIntoView` เองเมื่อกล้องติด (หน่วง 1 วิ ให้อ่านผลก่อน)
